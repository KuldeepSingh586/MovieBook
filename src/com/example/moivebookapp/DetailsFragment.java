...
public class DetailsFragment extends Fragment
{
   ...
   private long rowID = 0; // selected Movie's rowID
   private TextView titleTextView; // displays Movie's name 
   private TextView yearTextView; // displays Movie's phone
   private TextView directorTextView; // displays Movie's email
   private TextView ratingTextView; // displays Movie's street
   private TextView lengthTextView; // displays Movie's city
   private TextView typeTextView; // displays Movie's state
   private TextView soundeffectsTextView; // displays Movie's zip

    
   // set Details FragmentListener when fragment attached   
      ...
      Bundle savedInstanceState)
   {
      ...
      soundeffectsTextView = (TextView) view.findViewById(R.id.soundeffectsTextView);
      return view;
   }
   ...
   public boolean onOptionsItemSelected(MenuItem item) 
   {
      switch (item.getItemId())
      {
         ...
         case R.id.action_edit: 
          ...
          arguments.putCharSequence("soundeffects", soundeffectsTextView.getText());          
   ...
   private class LoadMovieTask extends AsyncTask<Long, Object, Cursor> 
   {
      ...
      protected Cursor doInBackground(Long... params)
      {
         ...
         return databaseConnector.getOneMoive(params[0]);
      } 
      ...
      protected void onPostExecute(Cursor result)
      {
         ...
         int soundeffectsIndex = result.getColumnIndex("soundeffects");
        ...
        soundeffectsTextView.setText(result.getString(soundeffectsIndex));
                     ...
                     DialogInterface dialog, int button)
                  {
                     ...
                     AsyncTask<Long, Object, Object> deleteTask =
                        new AsyncTask<Long, Object, Object>()
                        {
                           ...
                           {
                              databaseConnector.deleteMoive(params[0]); 
                              return null;
                           } 
